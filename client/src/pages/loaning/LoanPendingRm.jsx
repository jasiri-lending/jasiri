          ...
          <table className="w-full">
            <thead>
              <tr className="border-b" style={{ backgroundColor: '#E7F0FA' }}>
                ...
                <th className="px-4 py-3 text-center text-xs tracking-wider whitespace-nowrap" style={{ color: '#0D2440' }}>BM Approved</th>
                <th className="px-4 py-3 text-center text-xs tracking-wider whitespace-nowrap" style={{ color: '#0D2440' }}>Applied Date</th>
                    ...
                    <td className="px-4 py-3 text-sm text-center whitespace-nowrap">
                      <div className="flex flex-col items-center justify-center">
                        <div className="flex items-center gap-1 mb-1">
                          ...
                          <span className="text-xs" style={{ color: '#0D2440' }}>
        ...
        {filteredLoans.length === 0 && (
          <div className="p-10 text-center">
            ...
            <h3 className="text-sm font-semibold text-gray-700 mb-1">
              {searchTerm || selectedBranch || selectedRegion ? "No loans found" : "No pending approvals"}
            </h3>
