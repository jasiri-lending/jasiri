...
const CustomerStatementModal = () => {
  ...
  const exportToWord = () => {
    ...
    const firstName = customerInfo?.Firstname || "";
    const surname = customerInfo?.Surname || "";
    const customerName = `${firstName} ${surname}`.trim() || "Customer";
    ...
    const htmlContent = `
      <html xmlns:o='urn:schemas-microsoft-com:office:office' 
        ...
        <head>
          <meta charset="UTF-8">
          <title>${customerName} Account Statement</title>
          <style>
            @page {
              size: A4;
              margin: 1in;
        ...
        <body>
          <div class="header">
            <h1>JASIRI LENDING SOFTWARE</h1>
            <h2>${customerName} Account Statement</h2>
  ...
  const exportToExcel = async () => {
    ...
    const worksheetData = [
      ["JASIRI LENDING SOFTWARE"],
      [`${customerName} Account Statement`],
  ...
  const exportToPDF = async () => {
    ...
    // Header
    doc.setFontSize(14);
    doc.text("JASIRI LENDING SOFTWARE", 105, 15, { align: "center" });
    doc.setFontSize(11);
    doc.text(
      `${customerName} Account Statement`,
      105,
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className=" mb-6 p-6 text-center">
      <h2 className="text-sm sm:text-sm font-semibold text-slate-600 mb-1">
              ...
              <div className="flex gap-1 mx-2">
                {generatePageNumbers().map((page, index) => (
                  <button
                    ...
                    disabled={page === "..."}
                    className={`px-3 py-2 rounded-lg min-w-[40px] text-sm font-semibold transition-all shadow-sm ${
                      currentPage === page
