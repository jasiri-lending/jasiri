// src/pages/admin/UserGroups.jsx
import { useState } from 'react';
import { Plus, Search, Edit, Trash2, Users } from 'lucide-react';

const UserGroups = () => {
    const [groups, setGroups] = useState([
        { id: 1, name: 'Branch Managers', members: 12, permissions: 'Full Branch Access', status: 'Active' },
        { id: 2, name: 'Loan Officers', members: 25, permissions: 'Loan Processing', status: 'Active' },
    ]);
