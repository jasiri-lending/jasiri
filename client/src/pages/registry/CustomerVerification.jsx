              ...
              <>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {/* CSO Comment */}
                    <div className="bg-muted p-6 rounded-xl border border-amber-100">
                      <div className="flex items-center justify-between mb-4">
                    ...
                    {/* CSO Final Decision */}
                    <div className="bg-muted p-6 rounded-xl border border-orange-100">
                      <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-muted p-6 rounded-xl border-2 border-emerald-200">
                      <div className="flex items-center justify-between mb-4">
              ...
              <>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-muted p-6 rounded-xl border border-emerald-100">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="font-semibold text-emerald-900">
                          BM Scored Amount
                        </h4>
                  ...
                  {loanDetails && (
                    <div className="bg-muted rounded-xl p-6 border border-amber-200 mb-6">
