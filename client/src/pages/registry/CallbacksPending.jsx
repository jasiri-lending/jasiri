          ...
          {showFilters && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                {/* Region Filter - Show for credit_analyst_officer, customer_service_officer, and regional_manager */}
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-center whitespace-nowrap">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        {/* Callback Button - Only for Customer Service Officer */}
                        {profile?.role === "customer_service_officer" && (
                          <button
          ...
          <div className="px-5 py-4 border-t border-gray-200 bg-gray-50">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="text-sm text-gray-600">
                ...
                <span className="font-semibold text-gray-800">{filteredCustomers.length}</span> pending callbacks
              </div>
