    ...
    <div className="h-full bg-muted text-gray-800 border-r border-gray-200 transition-all duration-300 p-6 min-h-screen font-outfit">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-xs text-brand-primary ">
          <span className="font-medium text-brand-primary">{customers.length}</span> pending customers
        </div>
      </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1 rounded-md flex items-center gap-2 text-sm transition-all duration-200 border whitespace-nowrap"
                  style={{
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-center text-xs font-medium tracking-wider whitespace-nowrap text-slate-600">
                  Actions
                </th>
              </tr>
            </thead>
              ...
              {currentCustomers.map((customer, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-xs whitespace-nowrap text-slate-600" style={{ color: '#0D2440' }}>
