...
const Guarantors = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto bg-brand-surface min-h-screen">
      ...
      {notification && (
        <div className={`mb-6 p-4 rounded-lg flex items-center gap-3 ${notification.type === 'success' ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'
          }`}>
