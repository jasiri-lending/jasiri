...
Your loan repayment is due${dueText}. Please pay KES ${remainingInstallment.toLocaleString()} via Paybill No. ${PAYBILL}.
...
const message = `Dear ${customer.Firstname},
Your loan repayment is overdue by ${daysOverdue} day(s). Please pay KES ${remainingInstallment.toLocaleString()} via Paybill ${PAYBILL}.
AccountNumber-Your ID.Pay on time to avoid penalties.
`;
